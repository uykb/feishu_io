...
func Load() *Config {
	...
	hypeOIStopThreshold, _ := strconv.ParseFloat(getEnv("HYPE_OI_STOP_THRESHOLD", "-0.05"), 64)
	hypeFRExtremeThreshold, _ := strconv.ParseFloat(getEnv("HYPE_FR_EXTREME_THRESHOLD", "-0.0001"), 64)
	hypeFRRecoveryThreshold, _ := strconv.ParseFloat(getEnv("HYPE_FR_RECOVERY_THRESHOLD", "0.15"), 64)
	hypeHigherLowPct, _ := strconv.ParseFloat(getEnv("HYPE_HIGHER_LOW_PCT", "0.5"), 64)
	hypeSqueezePricePct, _ := strconv.ParseFloat(getEnv("HYPE_SQUEEZE_PRICE_PCT", "0.3"), 64)
	hypeSqueezeOIDeclinePct, _ := strconv.ParseFloat(getEnv("HYPE_SQUEEZE_OI_DECLINE_PCT", "0.02"), 64)
	...
	hypeHLOIStopThreshold, _ := strconv.ParseFloat(getEnv("HYPE_HL_OI_STOP_THRESHOLD", "-0.05"), 64)
	hypeHLFRExtremeThreshold, _ := strconv.ParseFloat(getEnv("HYPE_HL_FR_EXTREME_THRESHOLD", "-0.00002"), 64)
	hypeHLFRRecoveryThreshold, _ := strconv.ParseFloat(getEnv("HYPE_HL_FR_RECOVERY_THRESHOLD", "0.15"), 64)
	hypeHLSqueezePricePct, _ := strconv.ParseFloat(getEnv("HYPE_HL_SQUEEZE_PRICE_PCT", "0.3"), 64)
	hypeHLSqueezeOIDeclinePct, _ := strconv.ParseFloat(getEnv("HYPE_HL_SQUEEZE_OI_DECLINE_PCT", "0.02"), 64)
